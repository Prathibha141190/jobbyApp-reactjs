      ...
      <div className="job-item-success-container">
        ...
        <div className="bottom-container">
          ...
          <ul className="similar-list">
            {similarJobs.map(eachValues => (
              <li className="similar-item" key={eachValues.id}>
                <div className="icon-container">
                  <img
                    src={eachValues.companyLogoUrl}
                    className="company-logo"
                    alt="similar job company logo"
                  />
                  <div className="role-holder">
                    <h1 className="role">{eachValues.title}</h1>
                    <div className="rating-holder">
                      <BsStarFill className="star-image" />
                      <p className="rating">{eachValues.rating}</p>
                    </div>
                  </div>
                </div>
                <h1 className="description">Description</h1>
                <p className="description-para">{eachValues.jobDescription}</p>
                <div className="job-middle-container">
                  <div className="location-holder">
                    <div className="icon-holder">
                      <MdLocationOn className="md-icons" />
                      <p className="icon-names">{eachValues.location}</p>
                    </div>
                    <div className="icon-holder">
                      <MdWork className="md-icons" />
                      <p className="icon-names">{eachValues.employmentType}</p>
                    </div>
                  </div>
                  <p className="salary">{eachValues.packagePerAnnum}</p>
                </div>
              </li>
            ))}
          </ul>
